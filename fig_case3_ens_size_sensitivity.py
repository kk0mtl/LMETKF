...
# ==================================================
# plot Figs. 8, 9 and 10
# domain-averaged background RMSEs of the tested filters
#
# For each filter, organize the time-mean DA results into
# separate `t_*`, `rmse_b_*`, and `sprd_b_*` arrays for DA time,
# background RMSE, and background ensemble spread, respectively.
# The array elements must follow the ensemble-size order in `nem`
# ==================================================

# nem : number of ensemble members (x-axis : log-scale)
